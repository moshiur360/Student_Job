        ...
        <div class="row" >
            ...
            <div class="col-md-8">
                <table class="table">
                    ...
                    <tr>
                        <td><img src="{{ asset('/storage/'.$post->image)}}" width="80" alt="logo"></td>
                        <td>{{$post->title}}</td>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal{{ $post->id }}">
                                Delete
                            </button>
